                    ...
                    <div class="col-lg-12 col-xl-8 offset-xl-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') }}" placeholder="Nhập tên cửa hàng">
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                                name="address" value="{{ old('address') }}" placeholder="Nhập địa chỉ cửa hàng">
                            @error('address')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" class="form-control @error('link_map') is-invalid @enderror" id="map"
                                name="link_map" value="{{ old('link_map') }}" placeholder="Nhập đường dẫn Google Maps">
                            @error('link_map')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ old('phone') }}" placeholder="Nhập số điện thoại cửa hàng">
                            @error('phone')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                ...
                                placeholder="Nhập mô tả cửa hàng">{{ old('description') }}</textarea>
                            @error('description')
                        ...
                        <div class="block-options mb-5">
                            <button type="submit" class="btn btn-primary me-2">Tạo cửa hàng</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const fields = ['name', 'address', 'map', 'phone', 'image', 'description'];
