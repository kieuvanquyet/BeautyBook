          ...
          <ul class="nav-main">
            ...
            {{-- STORE --}}
                ...
                <ul class="nav-main-submenu{{ request()->is('admin/stores/*') ? ' show' : '' }}">
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('admin/stores/') ? ' active' : '' }}" href="{{ route('admin.stores.index') }}">
                      <span class="nav-main-link-name">Danh sách cửa hàng</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('admin/stores/create') ? ' active' : '' }}" href="{{ route('admin.stores.create') }}">
                      <span class="nav-main-link-name">Thêm mới cửa hàng</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-main-item{{ request()->is('admin/bookings/*') || request()->is('admin/bookings') ? ' open' : '' }}">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="{{ request()->is('admin/bookings/*') ? 'true' : 'false' }}" href="#">
                    <i class="nav-main-link-icon fa fa-calendar-check"></i>
                    <span class="nav-main-link-name">Bookings</span>
                </a>
                <ul class="nav-main-submenu{{ request()->is('admin/bookings/*') ? ' show' : '' }}">
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->is('admin/bookings') ? ' active' : '' }}" href="{{ route('admin.bookings.index') }}">
                            <span class="nav-main-link-name">Danh sách</span>
                        </a>
                    </li>
                </ul>
            ...
            @if(auth()->user()->role === 'staff')
              <li class="nav-main-item{{ request()->is('admin/*') || request()->is('admin/') ? ' open' : '' }}">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="{{ request()->is('admin/*') ? 'true' : 'false' }}" href="#">
                      <i class="nav-main-link-icon fa fa-calendar-check"></i>
                      <span class="nav-main-link-name">Bookings</span>
                  </a>
                  <ul class="nav-main-submenu{{ request()->is('admin/*') ? ' show' : '' }}">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('admin/') ? ' active' : '' }}" href="{{ route('admin.staff.bookings', auth()->user()->staffId) }}">
                              <span class="nav-main-link-name">Danh sách</span>
                          </a>
                      </li>
                  </ul>
